...
LABEL_SUFFIX = '_laneBinaryTrainIds.png'

# Dictionaries specifying which Apolloscape segmentation color corresponds to
# which 'trainId' value
#     Key: RGB color --> Value: trainId integer
# Ref: config_v2.0.json provided in the dataset
SEG_COLOR_DICT_LANE_BINARY = {
    (255, 255, 255):1,  # Lane Marking - Dashed Line
    (255, 255, 255):1,  # Lane Marking - Straight Line
    (250, 170, 29):1,  # Lane Marking - Zigzag Line
    (250, 170, 28):1,  # Lane Marking - Ambiguous
    (250, 170, 26):1,  # Lane Marking - Arrow (Left)
    (250, 170, 25):1,  # Lane Marking - Arrow (Other) 
    (250, 170, 24):1,  # Lane Marking - Arrow (Right)
    (250, 170, 22):1,  # Lane Marking - Arrow (Split Left or Straight)
    (250, 170, 21):1,  # Lane Marking - Arrow (Split Right or Straight)
    (250, 170, 20):1,  # Lane Marking - Arrow (Straight)
    (255, 255, 255):1,  # Lane Marking - Crosswalk 
    (250, 170, 19):1,  # Lane Marking - Give Way (Row)
    (250, 170, 18):1,  # Lane Marking - Give Way (Single)
    (250, 170, 12):1,  # Lane Marking - Hatched (Chevron)
    (250, 170, 11):1,  # Lane Marking - Hatched (Diagonal)
    (255, 255, 255):1,  # Lane Marking - Other
    (255, 255, 255):1,  # Lane Marking - Stop Line
    (250, 170, 16):1,  # Lane Marking - Symbol (Bicycle)
    (250, 170, 15):1,  # Lane Marking - Symbol (Other)
    (250, 170, 15):1,  # Lane Marking - Text
    (255, 255, 255):1,  # Lane Marking (only) - Dashed Line
    (255, 255, 255):1,  # Lane Marking (only) - Crosswalk
    (255, 255, 255):1,  # Lane Marking (only) - Other
    (255, 255, 255):1  # Lane Marking (only) - Test
}
